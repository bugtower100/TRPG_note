    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12 px-2 sm:px-0">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 border-b pb-3">
        <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
          <button onClick={() => navigate('/locations')} className="inline-flex items-center whitespace-nowrap shrink-0 text-gray-500 hover:text-gray-700">
            &larr; 返回
          </button>
          <input
            ...
            style={{ color: location.titleColor || '#111827' }}
          />
          <input
            type="color"
            value={location.titleColor || '#111827'}
            onChange={(e) => handleChange('titleColor' as keyof Location, e.target.value)}
