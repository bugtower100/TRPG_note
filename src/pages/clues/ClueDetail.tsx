    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12 px-2 sm:px-0">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 border-b pb-3">
        <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
          ...
          <input
            ...
            style={{ color: clue.titleColor || '#111827' }}
          />
          <input
            type="color"
            value={clue.titleColor || '#111827'}
            onChange={(e) => handleChange('titleColor' as keyof Clue, e.target.value)}
        ...
        <div className="flex items-center gap-2 sm:gap-3">
            ...
            <EntityShareActions entityType="clues" entity={clue} scope="entity" label="分享整张卡片" />
            <button
      ...
      <div className="space-y-6">
        ...
        <CollapsibleSection
          ...
          headerActions={<ShareSectionAction entityType="clues" entity={clue} sectionKey="detail" />}
        >
          <CustomSubItemsEditor
            ...
            renderItemActions={(item) => <ShareSubItemAction entityType="clues" entity={clue} item={item} />}
          />
        </CollapsibleSection>
        )}
        ...
        {(clue.customSections || []).map((sectionKey) => (
          <CollapsibleSection
            ...
            headerActions={<ShareSectionAction entityType="clues" entity={clue} sectionKey={sectionKey} />}
          >
            <CustomSubItemsEditor
