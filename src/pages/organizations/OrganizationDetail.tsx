    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12 px-2 sm:px-0">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 border-b pb-3">
        <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
          ...
          <input
            ...
            style={{ color: organization.titleColor || '#111827' }}
          />
          <input
            type="color"
            value={organization.titleColor || '#111827'}
            onChange={(e) => handleChange('titleColor' as keyof Organization, e.target.value)}
      ...
      <div className="space-y-6">
        ...
        <CollapsibleSection
          ...
          headerActions={<ShareSectionAction entityType="organizations" entity={organization} sectionKey="detail" />}
        >
          <CustomSubItemsEditor
            ...
            renderItemActions={(item) => <ShareSubItemAction entityType="organizations" entity={organization} item={item} />}
          />
        </CollapsibleSection>
        )}
        ...
        {(organization.customSections || []).map((sectionKey) => (
          <CollapsibleSection
            ...
            headerActions={<ShareSectionAction entityType="organizations" entity={organization} sectionKey={sectionKey} />}
          >
            <CustomSubItemsEditor
